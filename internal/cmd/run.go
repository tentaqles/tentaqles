...
func execIn(ws *resolve.Workspace, name string, args []string, errw func(string)) error {
	if name == "claude" {
...
func newRunCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(c *cobra.Command, args []string) error {
			...
			return execIn(ws, args[1], args[2:], func(s string) { fmt.Fprintln(c.ErrOrStderr(), "warning:", s) })
		},
	}
}
